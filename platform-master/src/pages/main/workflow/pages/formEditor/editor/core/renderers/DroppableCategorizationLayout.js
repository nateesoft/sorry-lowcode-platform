...
const DroppableCategorizationLayout = props => {
  ...
  const indicatorColor = categories.length === 0 ? "primary" : "secondary"

  const setIndex = (value, event) => {
