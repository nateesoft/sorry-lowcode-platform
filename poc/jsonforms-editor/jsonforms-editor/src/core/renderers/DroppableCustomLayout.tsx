...
interface DroppableCustomLayoutProps {
  schema: JsonSchema;
  layout: EditorLayout;
  path: string;
...
export const DroppableCustomLayout: React.FC<DroppableCustomLayoutProps> = ({
  schema,
  layout,
  path,
  direction,
...
export const DroppableCustomHorizontalLayoutRegistration = {
  tester: rankWith(45, uiTypeIs('CustomHorizontalLayout')),
  renderer: withJsonFormsLayoutProps(createRendererInDirection('row')),
};
export const DroppableCustomVerticalLayoutRegistration = {
  tester: rankWith(45, uiTypeIs('CustomVerticalLayout')),
